...
namespace MusicApplication.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SongID,NameSong,Singer,Content")] Song song,int[] categoriesId)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SongID,NameSong,Singer,Content")] Song song)
        {
            if (id != song.SongID)
            {
                return NotFound();
